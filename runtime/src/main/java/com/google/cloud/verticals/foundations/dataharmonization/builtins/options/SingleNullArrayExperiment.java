...
/** Option which allows the creation of array with a single null value. */
public class SingleNullArrayExperiment implements Option {
  ...
  public String getName() {
    return Option.experiment("single_null_array");
  }

  public static boolean isEnabled(RuntimeContext context) {
    return context.enabledOptions().stream().anyMatch(SingleNullArrayExperiment.class::isInstance);
  }
}

...
public class SpacingFunctionCallTest {
  Function<WhistleParser, RuleContext> programParserRule = WhistleParser::program;
  String directory = "spacingFunctionCallTest/";
  String input = "_input.wstl";
  String output = "_output.wstl";

  @Test
  public void spacingFunctionCall_noNewlines_noChange() throws IOException {
    ...
    BaseTreeNode result =
        linter.lint(
            ...
            Arrays.asList(new SpacingBlock(), new SpacingFunctionCall()));
    assertThat(toCodeString(result)).isEqualTo(getWhistleText(directory + testName + input));
  }

  @Test
  public void spacingFunctionCall_multipleNewlines_success() throws IOException {
  ...
  @Test
  public void spacingFunctionCall_singleMethod_success() throws IOException {
  ...
  @Test
  public void spacingFunctionCall_nestedFunctionCalls_success() throws IOException {
    String testName = "nestedFunctionCalls";
    Linter linter = new Linter();
    BaseTreeNode result =
        linter.lint(
            getWhistleText(directory + testName + input),
  ...
  @Test
  public void spacingFunctionCall_multipleMethods_success() throws IOException {
  ...
  @Test
  public void spacingFunctionCall_alreadyIndented_noChange() throws IOException {
  ...
  @Test
  public void spacingFunctionCall_tooManyIndents_success() throws IOException {
  ...
  @Test
  public void spacingFunctionCall_singleNewline_success() throws IOException {
  ...
  @Test
  public void spacingFunctionCall_bracketLastLine_success() throws IOException {
